            ...
            <div class="container-fluid">
                ...
                <div class="card p-4">
                    <div class="card-header">
                        <h3 class="card-title">{{__('invoice table')}}</h3>
                        <div class="card-tools">
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createinvoiceModal">
                                <i class="fas fa-invoice-plus"></i> @lang('add invoice')
                            </button>
        ...
        @push('jsModal')
            ...
            <script>
                $(document).ready(function () {
                    ...
                    {{--const invoiceinvoiceRoute = "{{ route('invoices.invoice') }}";--}}
