                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-category">
                            ...
                            <div class="images">
                                <img src="1.jpg" alt="#" width="180" height="180">
                            </div>
                        </div>
                        <!-- End Single Category -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                ...
                                <div class="single-product">
                                    <div class="product-image">
                                        <img src="1.jpg" width="335" height="335" alt="#">
                                        <div class="button">
                        ...
                        <div class="single-banner right"
                             style="background-image:url('1.jpg');margin-top: 30px;">
                            <div class="content">
                    ...
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="offer-content">
                            <div class="image">
                                <img src="1.jpg" width="510" height="600" alt="#">
                        ...
                        <div class="single-blog">
                            <div class="blog-img">
                                <a href="blog-single-sidebar.html">
                                    <img src="1.jpg" width="370" height="215" alt="#">
                                </a>
                            </div>
